...
export const zhTw: Translations = {
  ...
  home: {
    ...
    max: '最大:1000',
    selectDays: '請選擇天數',
    day1: (params: { day: number; percent: string }) => `${params.day}天,複利 ${params.percent}%`,
    day15: (params: { day: number; percent: string }) => `${params.day}天,複利 ${params.percent}%`,
    day30: (params: { day: number; percent: string }) => `${params.day}天,複利 ${params.percent}%`,
    cancel: '取消',
    confirm: '確定',
    ...
    validationWithdrawAddressRequired: '請輸入提款地址',
    validationWithdrawAmountInvalid: '提款金額必須大於0',
    validationWithdrawAddressInvalid: '請輸入有效的TRON網絡地址（T開頭，34個字符）',
    validationWithdrawDaysRequired: '平台禮金無法直接提現，需質押7天後再申請提現',
    processing: '處理中...'
  }
}
